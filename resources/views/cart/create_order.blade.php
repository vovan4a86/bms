                                            ...
                                            <div class="cart-data__col">
                                                <div class="cart-radio">
                                                    <label class="cart-radio__label">
                                                        <input class="cart-radio__input" type="radio" name="delivery"
                            ...
                            <div class="cart-view__body">
                                @foreach($items as $item)
                                    <div class="cart-view__row">
                                        <dl class="dl-reset">
                                            <dt>{{ $item['name'] }}</dt>
                                            <dd>{{ $item['weight'] * $item['price'] }} руб.</dd>
                                        </dl>
                                    </div>
                                @endforeach
                                <div class="cart-view__row">
                                ...
                                <div class="cart-view__callback">
                                    <label class="checkbox-callback">
                                        <input class="checkbox-callback__input" type="checkbox" name="callback"
                                               value="Нужен звонок оператора" checked>
                                ...
                                <div class="cart-view__policy">Завершая оформление Заказа, я подтверждаю свою
                                    ...
                                    ознакомление с
                                    <a href="javascript:void(0)" target="_blank">«Соглашением с покупателем»</a>
                                </div>
                            </div>
                        </div>
                    </div>
